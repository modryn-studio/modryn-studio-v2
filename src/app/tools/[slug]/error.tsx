...
export default function Error({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 px-4 text-center">
      <p className="text-muted-foreground font-mono text-xs tracking-widest uppercase">Tools</p>
      <h1 className="text-foreground text-2xl font-bold">Couldn&apos;t load this tool.</h1>
      <p className="text-muted-foreground max-w-md text-sm">
        Something went wrong loading this tool page.
      </p>
