...
export interface LogPost {
  ...
  seoTitle?: string;
  /** Custom share text for X/Twitter pre-fill. Defaults to the post title if absent. */
  shareText?: string;
  /** Optional cover image path (e.g. /log/covers/slug.jpg). Generated by scripts/gen-cover.mjs. */
  cover?: string;
  content: string;
  /** Estimated reading time in minutes (words / 200, minimum 1). */
  readingTime: number;
}
