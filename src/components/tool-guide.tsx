  ...
  return (
    <div className="mt-10">
      ...
      <ReactMarkdown
        components={{
          h2: ({ children }) => (
            <h2 className="text-foreground mt-8 mb-3 font-mono text-sm font-semibold tracking-wide uppercase">
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-foreground mt-6 mb-2 font-mono text-xs font-semibold tracking-wide">
              {children}
            </h3>
          ),
          p: ({ children }) => (
          ...
          ol: ({ children }) => <ol className="mb-4 list-decimal space-y-1 pl-4">{children}</ol>,
          li: ({ children }) => (
