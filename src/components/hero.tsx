...
export default function Hero() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-24 md:py-32 lg:py-40">
      <h1 className="font-heading text-4xl font-bold leading-[1.05] tracking-tighter sm:text-5xl lg:text-6xl">
      ...
      <p className="mt-6 max-w-xl font-mono text-base leading-relaxed text-muted-foreground md:text-lg">
        I&apos;m Luke. I build fast, focused AI tools — one at a time. No fluff.
        No traps. Just things that work.
      </p>
      <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
        <a href="#tools">
          <Button className="rounded-none bg-amber text-white font-mono text-sm hover:bg-amber/90 h-11 px-6">
            See what&apos;s building
