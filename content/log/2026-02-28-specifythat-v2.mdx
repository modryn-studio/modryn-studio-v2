...
tool: specifythat
related:
	- 2026-02-26-specifythat
description: "SpecifyThat v2 is live. It doesn't make specs — it makes context files. The distinction changes how it's used, how it's explained, and what it's for."
seoTitle: 'SpecifyThat is live — context files, not specs | Build Log'
---
