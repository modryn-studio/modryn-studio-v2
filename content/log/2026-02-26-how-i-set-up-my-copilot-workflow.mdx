...
tag: build
related:
	- 2026-03-11-5-phase-build-workflow
description: 'How I set up the .github/ folder that turns VS Code Copilot into a disciplined co-pilot. Instructions, prompts, agents, and pre-commit hooks — all explained.'
seoTitle: 'How I set up my AI coding workflow with VS Code Copilot | Build Log'
---
