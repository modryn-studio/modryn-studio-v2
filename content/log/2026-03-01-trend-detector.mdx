...
tag: trend-detector
tool: trend-detector
description: "I built a pipeline that tells me what to build next. Every morning it scores 400+ rising trends and outputs BUILD/WATCH/SKIP decisions before I've had coffee."
seoTitle: 'I built a pipeline that tells me what to build next | Build Log'
---
...
- **The whole thing runs ~13 API calls.** Free tier Brave Search for competitor checking, OpenAI for cluster naming. Everything else is free.
