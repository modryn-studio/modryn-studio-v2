---
name: launch
description: 'Distribution checklist: sharing hooks, social footer, and share-on-X hooks.'
agent: agent
---
...
1. **Monitor Vercel Analytics** — Check which channels drove actual signups/usage in the Vercel dashboard Analytics tab.
